...
import { ArrowRight, Calendar, User, Moon, Sun, ImageIcon } from "lucide-react"
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (savedContent) {
        ...
        setGalleryItems(content.galleries || [])
      }
    }
  }, [])
        ...
        <section className="min-h-screen flex items-center justify-center px-8 md:px-12 lg:px-16 relative">
          ...
          <div className="max-w-6xl mx-auto text-center relative">
            ...
            <p className="text-lg md:text-2xl lg:text-3xl text-gray-700 dark:text-white/80 mb-12 md:mb-16 max-w-3xl mx-auto leading-relaxed font-light">
              INHA VENTURE CLUB의 다양한 활동 모습을 확인하세요
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-8 md:px-12 lg:px-16">
            {galleryItems.length > 0 ? (
              ...
              <div className="text-center py-16">
                <ImageIcon className="w-16 h-16 mx-auto mb-4 text-gray-400 dark:text-white/40" />
                <h3 className="text-xl font-medium mb-2">갤러리가 비어있습니다</h3>
                <p className="text-gray-600 dark:text-white/70">관리자가 사진을 추가할 때까지 기다려주세요.</p>
              </div>
            )}
          </div>
        </section>
